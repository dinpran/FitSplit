...
import 'package:fitsplit/full_body/intermediate/intermediate_lunges.dart';
import 'package:fitsplit/videoplayerwidget.dart';

class IntermediatePushups extends StatefulWidget {
  const IntermediatePushups({Key? key}) : super(key: key);

  @override
  State<IntermediatePushups> createState() => _IntermediatePushupsState();
}

class _IntermediatePushupsState extends State<IntermediatePushups> {
                ...
                child: FloatingActionButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => IntermediateLunges()));
                  },
  ...
  Future<void> _speakInstructions() async {
    String instructions =
        "Do 4 sets of 15 repetitions. To perform pushups, start in a plank position with your hands shoulder-width apart and your body in a straight line from head to heels. Lower your body until your chest nearly touches the floor, keeping your elbows close to your sides. Push back up to the starting position, fully extending your arms. Repeat the movement for the prescribed number of repetitions.Take Rest for 1 minute after each set.";
